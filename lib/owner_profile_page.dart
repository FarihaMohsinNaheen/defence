...
//     try {
//       // Using 'users' collection as you said
...
//   // Auto-save on dialog close, no Save button needed
...
//     if (newName.isEmpty || newBusiness.isEmpty) return; // Skip if empty
...
class _OwnerProfilePageState extends State<OwnerProfilePage> {
  ...
  // Bottom nav
  int currentIndex = 3; // Profile is index 3
