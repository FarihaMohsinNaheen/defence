...
//       // Student notification - NEWLY ADDED
//       await FirebaseFirestore.instance.collection('notifications').add({
//         'user_id': widget.user.uid,
//         'type': 'booking_cancelled',
//         'title': 'Booking Cancelled',
//         'desc':
//             'Your booking at $hostelName Room $roomNumber has been cancelled. Refund: Tk $amount',
//         'time': FieldValue.serverTimestamp(),
//         'read': false,
...
//       // NEW: Check if booking was approved before
...
//       // Owner notification - ONLY if approved before - CHANGED COLLECTION
...
// // FIXED: Read camelCase first, fallback to snake_case for old docs
// final hostelName = data['hostelName'] ?? data['hostel_name'] ?? 'Hostel';
// final roomNumber = data['roomNumber'] ?? data['room_number'] ?? 'Room';
// final businessName = data['businessName'] ?? data['businessName'] ?? 'Business'; // same both ways
...
// final ownerName = data['ownerName'] ?? data['businessName'] ?? 'Owner'; // you had businessName twice

// final totalAmount = perBedPrice * bedsBooked;
// final paidTime = (data['paidAt'] ?? data['paid_at'] ?? Timestamp.now()).toDate();
...
//                       return ElevatedButton.icon(
//                         onPressed: () async {
//   final chatId = getChatId(widget.user.uid, ownerId);

//   // ensure chat doc exists with correct fields
//   await FirebaseFirestore.instance.collection('chats').doc(chatId).set({
//     'participants': [widget.user.uid, ownerId],
//     'studentId': widget.user.uid,
//     'ownerId': ownerId,
//     'hostelId': hostelId,      // keep this for display
//     'hostelName': hostelName,
//     'ownerName': ownerName,
//     'lastMessage': '',
...
//         data['ownerName'] ??
//         data['businessName'] ??
//         'Owner'; // you had businessName twice
