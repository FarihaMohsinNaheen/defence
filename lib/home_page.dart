...
//             .map((r) => (r['price'] ?? 999) as int)
//             .fold(999, (min, price) => price < min ? price : min);
...
//                           onSelected: (value) {
//                             setState(() {
//                               priceSortOrder = value; // "low", "high", or ""
//                               activeFilter =
//                                   "Price"; // Price select করলে অন্য ফিল্টার off
//                             });
//                           },
    ...
    if (priceSortOrder == "low") {
      ...
      filtered.sort((a, b) {
        ...
        final aMaxPrice = aRooms
            ...
            .fold(0.0, (max, price) => price > max ? price : max); // FIXED 0.0
        final bMaxPrice = bRooms
            .map((r) => (r['price'] ?? 0).toDouble()) // FIXED
            .fold(0.0, (max, price) => price > max ? price : max); // FIXED 0.0
        return bMaxPrice.compareTo(aMaxPrice);
